...
lmarker Tools::lidarSense(Car& car, pcl::visualization::PCLVisualizer::Ptr& viewer, long long timestamp, bool visualize, ofstream& out_file_)
{
    ...
    out_file_ << car.ukf.NIS_laser_ << ", 5.991 " << "\n";
...
rmarker Tools::radarSense(Car& car, Car ego, pcl::visualization::PCLVisualizer::Ptr& viewer, long long timestamp, bool visualize, ofstream& out_file_)
{
    ...
    out_file_ << car.ukf.NIS_radar_ << ", 7.815" << "\n";
